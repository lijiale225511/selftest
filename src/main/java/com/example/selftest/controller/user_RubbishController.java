...
@RestController
@RequestMapping(value = "/api/user_rubbish")
public class user_RubbishController {

    private final RubbishService rubbishService;

    @Autowired(required = true)
    public user_RubbishController(RubbishService rubbishService) {
    ...
    public TableRspDTO list5Table(TableReqDTO tableReqDTO) {
        ...
        try {
            tableRspDTO = rubbishService.list6Table(tableReqDTO);
        } catch (Exception e) {
